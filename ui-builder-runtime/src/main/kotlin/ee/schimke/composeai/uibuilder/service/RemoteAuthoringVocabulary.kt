 ...
 *
 * Applied by the `remote-compose` curation in [composeFoundationCatalog], which hands it to every
 * published Remote Compose catalog. Every clause here moves a refusal from export time to the
 * moment the author acts, which is the only moment they can do anything about it.
 */
...
/**
 * The Remote Compose palette's shelves: the Lottie element under Content, then each Remote Material
 * 3 component under the shelf the published catalog files it on.
 *
